...
import { POSTS_ENDPOINT, POSTS_CATEGORIES_ENDPOINT, POSTS_TAGS_ENDPOINT } from '@/constant/api-endpoints'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="text-gray-600">Noticias, artículos y recursos legales</p>
        </div>
      </div>
              ...
              <div className="space-y-2">
                ...
                {categories.map((cat) => (
                  <button
                    ...
                    className={`block w-full text-left px-3 py-2 rounded hover:bg-gray-100 ${
                      selectedCategory === cat.slug ? 'bg-blue-50 text-blue-600' : 'text-gray-700'
                    }`}
                  >
                    {cat.name}
                  </button>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-sm text-blue-800">
                    ...
                    {searchQuery && (
                      <span className="bg-white px-3 py-1 rounded">Búsqueda: {searchQuery}</span>
                    )}
                    {selectedCategory && (
