...
export default function CreateClosingPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (!negotiationId) {
                throw new Error("Debe ingresar un ID de negociación")
            }

            const response = await fetch(`${CLOSINGS_ENDPOINT}/from-negotiation/${negotiationId}`, {
                method: "POST",
                headers: {
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight">Crear Nuevo Cierre</h1>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2 md:col-span-2">
                        <label className="text-sm font-medium">
                            ID de Negociación <span className="text-red-500">*</span>
                        </label>
                        <input
                            type="text"
                            value={negotiationId}
                            ...
                            placeholder="Ingrese el ID de la negociación"
                            required
                        />
                    </div>
