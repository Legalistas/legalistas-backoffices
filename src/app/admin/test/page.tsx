...
export default function TimezoneDebug() {
	...
	const updateTimes = () => {
		...
		setTimezoneInfo(
			`Offset en minutos: ${offset}, Nombre: ${Intl.DateTimeFormat().resolvedOptions().timeZone}`,
		);
		...
		<Card>
			...
			<CardContent className="space-y-4">
				...
				<div>
					...
					<p className="text-sm">
						{diffMinutes} minutos ({Math.floor(diffMinutes / 60)} horas y{" "}
						{diffMinutes % 60} minutos)
					</p>
				</div>
