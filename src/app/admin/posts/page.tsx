...
import { POSTS_ENDPOINT, POST_BY_ID_ENDPOINT } from '@/constant/api-endpoints'
    ...
    <div className="min-h-screen">
      <div className="mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Administrar Posts</h1>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <p className="text-sm text-gray-600">
                    Mostrando {(currentPage - 1) * perPage + 1} a {Math.min(currentPage * perPage, totalPosts)} de {totalPosts} posts
                  </p>
                  <select
                    value={perPage}
                    onChange={(e) => {
