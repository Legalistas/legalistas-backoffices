...
import { Check, ChevronDown, Clock, Trophy, XCircle } from "lucide-react";
...
const resultConfig: Record<
	string,
	{ bg: string; color: string; hoverBg: string; icon: typeof Clock }
> = {
	IN_PROGRESS: {
		bg: "#dbeafe",
		color: "#2563eb",
...
export function ResultSelectDropdown({
	currentResult,
	onResultChange,
}: ResultSelectDropdownProps) {
