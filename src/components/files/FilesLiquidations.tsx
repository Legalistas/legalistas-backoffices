...
import { FileText, Calculator, Download, Clock } from 'lucide-react'
...
export default function FilesLiquidations({ caseId, fileId }: FilesLiquidationsProps) {
    ...
    const handleCalculate = () => {
        router.push(`/admin/calculator/accidents-work?caseId=${caseId}&fileId=${fileId}`)
    }
