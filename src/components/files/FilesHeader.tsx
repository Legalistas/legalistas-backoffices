			...
			<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
				<div className="flex items-center">
					...
					<div>
						...
						<p className="text-sm text-gray-500 mt-1">
							<span className="font-medium">{file?.cuij}</span> •{" "}
				...
				<div className="flex 2xl:hidden items-center space-x-2 relative">
					<Button
						onClick={handleEdit}
						variant="default"
						className="inline-flex items-center justify-center font-medium gap-2 rounded-lg transition bg-primary text-white hover:bg-primary/80 hover:text-gray-dark p-2"
					>
						<Edit className="h-4 w-4" />
						Editar
					</Button>
					...
					>
						<DropdownItem
							onClick={() => {
								/* lógica imprimir */ setDropdownOpen(false);
							}}
						>
						...
						<DropdownItem
							onClick={() => {
								/* lógica descargar */ setDropdownOpen(false);
							}}
						>
						...
						<DropdownItem
							onClick={() => {
								/* lógica compartir */ setDropdownOpen(false);
							}}
						>
