...
import { Activity, Mail, Phone, Calendar, FileText, CheckSquare, RefreshCw, Plus, type LucideIcon, User } from "lucide-react"
                ...
                <div className="space-y-4">
                    {lead.crmLeadLogs && lead.crmLeadLogs.length > 0 ? (
                            ...
                            .map((log, index) => {
                                ...
                                return (
                                    <div key={index} className="flex">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium">{log.title} • <span className="text-muted-foreground font-normal">{formatDate(log.createdAt)}</span></p>
                        ...
                        <div className="text-center py-6">
                            ...
                            <p className="mt-2 text-muted-foreground">No hay actividades registradas</p>
                        </div>
                    )}
                </div>
            </CardContent>
