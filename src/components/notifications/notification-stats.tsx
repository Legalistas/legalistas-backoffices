...
export default function NotificationStats({ notifications }: NotificationStatsProps) {
    ...
    const infoCount = notifications.filter((n) => n.type === "info" || n.type === "normal").length
    ...
    const causesFilesCount = notifications.filter((n) => n.type === "causes_files").length
    const expedienteCount = notifications.filter((n) => n.type === "expediente").length
