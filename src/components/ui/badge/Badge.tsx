...
const Badge: React.FC<BadgeProps> = ({
  ...
  const variants = {
    ...
    outline: {
      ...
      success: "border border-success-500 text-success-500 dark:border-success-500 dark:text-success-500",
      error: "border border-error-500 text-error-500 dark:border-error-500 dark:text-error-500",
      warning: "border border-warning-500 text-warning-500 dark:border-warning-400 dark:text-orange-400",
      info: "border border-blue-light-500 text-blue-light-500 dark:border-blue-light-500 dark:text-blue-light-500",
      light: "border border-gray-300 text-gray-700 dark:border-white/20 dark:text-white/80",
      dark: "border border-gray-700 text-gray-700 dark:border-white/20 dark:text-white",
    }
  };
