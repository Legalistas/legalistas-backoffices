			...
			<div className="mb-6 flex flex-col items-center sm:flex-row sm:items-start gap-6">
				...
				<div className="flex-1">
					<p className="text-sm text-gray-500 dark:text-gray-400 mb-2">
						Sube una foto para tu perfil. Recomendamos una imagen de al menos
						400x400 píxeles.
					</p>
					<button
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
				...
				<div>
					...
					<small className="block text-xs text-gray-500 dark:text-gray-400 mt-1">
						El correo electrónico no se puede modificar,{" "}
						<Link href="/admin/ticket">contacta a soporte</Link>.
					</small>
				</div>
				<div>
					<label
					...
					<p className="mt-1 text-xs text-gray-500">
						Valor actual: {profileData.docType || "No seleccionado"}
					</p>
				</div>
				<div>
					<label
				...
				<div>
					...
					/>
					<p className="mt-1 text-xs text-gray-500">
						Valor actual: {profileData.gender || "No seleccionado"}
					</p>
				</div>
			</div>
		</>
