...
export default function SalesPerformance() {
    ...
    useEffect(() => {
        async function fetchStats() {
            ...
            try {
                const res = await fetch(`${STATISTICS_CRM_DASHBOARD_ENDPOINT}/${session.user.id}?timeframe=${activeTab}`, {
                    headers: {
    ...
    return (
        <Card className="col-span-1">
            <CardHeader>
                ...
                <CardDescription>Comparación de leads ganados y perdidos</CardDescription>
            </CardHeader>
            <CardContent>
