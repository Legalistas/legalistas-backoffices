...
export default function CreateConsultationForm({ caseId, onSuccess, onCancel }: CreateConsultationFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true)
        try {
            const response = await fetch(CASES_CONSULTATIONS_CREATE_ENDPOINT(caseId), {
                method: "POST",
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-2 justify-end">
                ...
                <button type="submit" disabled={loading} className="px-3 py-1 bg-[#09A4B5] text-white rounded">
