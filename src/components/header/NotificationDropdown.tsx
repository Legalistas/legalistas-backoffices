...
import { AlertTriangle, Bell, Calendar, CheckCircle, FileText, Info, RefreshCcw, Scale, Settings, SquareKanban, X } from "lucide-react";
...
export default function NotificationDropdown() {
    const { unreadCount, refreshNotifications, notifications, loading } = useNotifications();
        ...
        <div className="relative">
            ...
            >
                ...
                <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
                    ...
                    {loading ? (
                        <div className="flex justify-center py-8">Cargando notificaciones...</div>
                        ...
                        <div className="flex flex-col items-center justify-center py-8 text-center w-full">
                            ...
                            <p className="text-sm text-muted-foreground">Las notificaciones aparecerán aquí cuando las recibas.</p>
                        </div>
                    ) : (
                                ...
                                >
                                    ...
                                    <span className="block">
                                        ...
                                        <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                                            ...
                                            <span>{formatDistanceToNow(new Date(notification.createdAt).getTime())}</span>
                                        </span>
                                    </span>
                                </DropdownItem>
                            </li>
