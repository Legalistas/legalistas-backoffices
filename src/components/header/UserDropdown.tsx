						...
						<Image
							...
							onError={(e) => {
								...
								target.parentElement!.innerHTML =
									'<div class="h-full w-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center rounded-full"><svg class="h-7 w-7 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg></div>';
							}}
						/>
					) : (
